export const CloseIcon = ({ width = '1em', height = '1em', className }) => {
    return (
        <svg
            stroke="currentColor"
            fill="currentColor"
...
export const PhoneIcon = ({ width = '1em', height = '1em', className }) => {
    return (
        <svg
            stroke="currentColor"
            fill="currentColor"
...
export const HasUserPhoneIcon = ({ width = '1em', height = '1em', className }) => {
    return (
        <svg
            stroke="currentColor"
            fill="none"
...
export const MenuIcon = ({ width = '1em', height = '1em', className }) => {
    return (
        <svg
            stroke="currentColor"
            fill="currentColor"
...
export const SendIcon = ({ width = '1em', height = '1em', className }) => {
    return (
        <svg
            stroke="currentColor"
            fill="none"
